...
#making sure columns joined correctly with a test dataframe
pop_scf <- covid_pop %>% 
...
#COVID/Population data to only include the last 14 days.

last_14_new <- covid_pop %>% 
